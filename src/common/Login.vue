  ...
  <div class="login-box">
    <div class="form">
      ...
      >
        ...
        <el-form-item>
          <el-button type="success" class="login-btn" @click="submitForm('formLabelLogin')">登录</el-button>
          <el-button type="primary" class="login-btn" @click="resetForm('formLabelLogin')"
            >立即重置</el-button
          >
        </el-form-item>
      </el-form>
